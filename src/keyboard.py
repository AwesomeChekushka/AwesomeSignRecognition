class ASRKeyboard:
    def __init__(self, bg_capture_keys, bg_reset_keys, exit_keys, gather_mode_keys, prediction_mode_keys):
        ...
        self.__prediction_mode_keys = prediction_mode_keys
    ...
    def is_prediction_mode_key(self, key: int) -> bool:
        return key in self.__prediction_mode_keys
